...
# TESTING
    to start a local development network, run ./start_ganache.sh

    to test: go into th eth-contracts directory and run:
...
# Required addresses
   ...
   # marketplace buyer:
    ...
    here is the ABI for the solnsquare verifier, the rest can be found in th eth-contracts/build/contracts folder
    [
    {
      "inputs": [
        {
